...
static const _LidarData_type_support_symbol_names_t _LidarData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wireless_lidar, msg, LidarData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wireless_lidar, msg, LidarData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wireless_lidar, msg, LidarData)() {
  return &::wireless_lidar::msg::rosidl_typesupport_c::LidarData_message_type_support_handle;
}
