...
static const _LidarData_type_support_symbol_names_t _LidarData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wireless_lidar, msg, LidarData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wireless_lidar, msg, LidarData)),
  }
};
...
{
  return &::wireless_lidar::msg::rosidl_typesupport_cpp::LidarData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wireless_lidar, msg, LidarData)() {
  return get_message_type_support_handle<wireless_lidar::msg::LidarData>();
}
