...
bool wireless_lidar__msg__point_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wireless_lidar.msg._point_data.PointData", full_classname_dest, 40) == 0);
  }
  wireless_lidar__msg__PointData * ros_message = _ros_message;
  {  // distance
...
{
  /* NOTE(esteve): Call constructor of PointData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("wireless_lidar.msg._point_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PointData");
