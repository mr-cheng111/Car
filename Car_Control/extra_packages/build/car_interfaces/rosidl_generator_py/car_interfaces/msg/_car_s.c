...
bool car_interfaces__msg__car__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("car_interfaces.msg._car.Car", full_classname_dest, 27) == 0);
  }
  car_interfaces__msg__Car * ros_message = _ros_message;
  {  // speed
...
PyObject * car_interfaces__msg__car__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("car_interfaces.msg._car");
